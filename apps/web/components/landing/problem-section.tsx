          ...
          {problems.map((problem, index) => (
            ...
            >
              ...
              <div className="relative">
                <div className="w-14 h-14 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-brand-secondary/10 to-orange-50 border border-brand-secondary/20 flex items-center justify-center group-hover:border-brand-secondary/40 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-brand-secondary/20 transition-all duration-300">
                  <problem.icon className="w-6 h-6 text-brand-secondary" />
                </div>
                <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-700 mb-3 text-center group-hover:from-brand-secondary group-hover:to-orange-500 transition-all duration-300">
                  {problem.title}
                </h3>

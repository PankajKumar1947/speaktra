        ...
        <div className="relative bg-card rounded-3xl p-8 lg:p-12 border border-border shadow-xl">
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="text-lg border-border text-foreground-muted hover:bg-accent px-8 py-4"
                >
            ...
            <div className="hidden lg:block relative">
              <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/10 to-background rounded-2xl blur-xl" />
              <div className="relative bg-muted rounded-2xl p-6 border border-border shadow-lg">
          ...
          <div className="mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-center gap-4 text-foreground-muted text-sm">
